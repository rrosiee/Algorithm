# 프로그래머스 60061번(https://school.programmers.co.kr/learn/courses/30/lessons/60061)

# 규칙 1 : 기둥은 바닥 위에 있거나, 보의 한쪽 끝에 있거나, 다른 기둥 위에 있어야 합니다.
#  => 기둥은 바닥 위에 있다.
#  => 보의 한쪽 끝에 있다(위로)
#  => 다른 기둥 위에 있어야 한다.

# 규칙 2 : 보는 한쪽 끝 부분이 기둥 위에 있거나, 양쪽 끝 부분이 다른 보와 동시에 연결되어야 합니다.
#  => 한쪽 끝 부분이 기둥 위에 있다.
#  => 양쪽 끝 부분이 다른 보와 동시에 연결 되어있다.


# frame_one = [0, 0, 0, 1]
# frame_current = [] => result와 같은 형식이 될 것임
import copy
